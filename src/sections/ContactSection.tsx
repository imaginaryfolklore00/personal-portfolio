  ...
  return (
    <section className="py-20 sm:py-32 px-6 sm:px-12 lg:px-24 max-w-7xl mx-auto flex flex-col items-center justify-center text-center min-h-[60vh]" ref={sectionRef}>
      ...
      <div className="contact-elem">
        <MagneticButton onClick={() => window.location.href = "mailto:nazeem.s2k@gmail.com"} className="px-10 py-5 text-lg">
      ...
      <div className="contact-elem mt-32 text-white/30 text-sm font-medium tracking-widest uppercase">
        © {new Date().getFullYear()} Nozimbek Abdugofurov. All rights reserved.
      </div>
    </section>
  );
}
